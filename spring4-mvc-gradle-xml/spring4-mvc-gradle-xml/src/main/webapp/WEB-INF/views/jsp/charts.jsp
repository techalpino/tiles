...
<body>
	...
	<spring:url value="/resources/core/js/plugins/morris/morris-data.js" var="morris-dataJs" />

	<script src="${bootstrapJs}"></script>
    <script src="${jqueryJs}"></script>
	<script src="${raphaelJs}"></script>
    <script src="${morrisJs}"></script>
	<script src="${morris-dataJs}"></script>

    <!-- Flot Charts JavaScript -->
    <!--[if lte IE 8]><script src="js/excanvas.min.js"></script><![endif]-->
    <spring:url value="/resources/core/js/plugins/flot/jquery.flot.js" var="jqueryFlotJs"/>
    <spring:url value="/resources/core/js/plugins/flot/jquery.flot.tooltip.min.js" var="jqueryFlotTooltipJs"/>
    <spring:url value="/resources/core/js/plugins/flot/jquery.flot.resize.js" var="jqueryFlotResizeJs"/>
    <spring:url value="/resources/core/js/plugins/flot/jquery.flot.pie.js" var="jqueryFlotPieJs"/>
    <spring:url value="/resources/core/js/plugins/flot/flot-data.js" var="jqueryFlotDataJs"/>
	...
	<script src="${jqueryFlotDataJs}"></script>
